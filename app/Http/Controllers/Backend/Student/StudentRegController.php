...
/* 	public function StudentRegDelete(Request $request, $id) {
...
public function StudentUpdataPromotion(Request $request, $student_id){
	DB::transaction(function() use($request,$student_id){
...
/* public function StudentRegDelete(Request $request, $student_id) {
    $user = AssignStudent::findOrFail($student_id);
    $user->delete();
...
public function StudentRegDelete($id) {
    ...
    if ($student) {
        $student->delete();
        AssignStudent::where('student_id', $id)->delete();
        DiscountStudent::where('assign_student_id', $id)->delete();
        $notification = array(
