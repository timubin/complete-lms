   ...
   <img src="{{ url('upload/easyschool.png') }}" style="width: 120px; height: 100px;">			
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>Eurosia Technologies ltd </strong></h4>
  			<h6><strong>Dhaka Bangladesh</strong></h6>
  			<h5><strong><u><i>Academic Transcript</i></u></strong></h5>
  			<h6><strong>{{ !empty($allMarks['0']['exam_type']['name']) ? $allMarks['0']['exam_type']['name'] : '' }}</strong></h6>

  			
  		</div>

  		<div class="col-md-12">
  <hr style="border: solid 1px; width: 100%; color: #000; margin-bottom: 0px;">
